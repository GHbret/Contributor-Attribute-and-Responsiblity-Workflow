...
2. **Scope it**: set **Applies to** = `Asset` the root type, which covers every asset type. Creating a
   rule, specific to an asset type here limits the workflow to that type only.
